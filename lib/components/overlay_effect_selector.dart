...
class OverlayEffectSelector extends StatefulWidget {
  ...
  OverlayEffectSelector({Key key, this.controller, this.onPageChanged, this.effects, this.currentPageValue}) : super(key: key);
      ...
      itemBuilder: (context, i) {
        Widget constructLabel() {
          if (i == this.widget.currentPageValue.floor()) {
            ...
            return Text(this.widget.effects[i], style: TextStyle(
                color: Color(0xffD8D8D8), 
                fontStyle: FontStyle.italic,
                fontSize: 14,
              ),
